...
const Navbar = () => {
  ...
  const { setSelectedSection } = useSharedContext();

  const handleItemClick = (section) => {
    setActiveLink("LebneneEle"); // Optional if you want to set the active link explicitly
    ...
    <header className="navbar-header">
      <div className="header-section">
        ...
        <div className="header-btns">
          ...
          <button className="continue-application" onClick={handleShowSubscription}>
            <div>
